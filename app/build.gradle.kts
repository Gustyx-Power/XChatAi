...
android {
    namespace = "id.xms.xcai"
    compileSdk = 36

    defaultConfig {
        applicationId = "id.xms.xcai"
        minSdk = 26
        targetSdk = 36
        versionCode = 1
        versionName = "1.3-Dev"
...
// Task to rename/copy app-release.apk to XChatAi-versionName.apk after assembleRelease
...
val renameReleaseApk by tasks.registering(Copy::class) {
    ...
    // Mengganti nama file
    rename { "XChatAi-$versionName.apk" }
}
